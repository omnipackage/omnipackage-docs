...
See also [Best practices → Test the installed package](https://docs.omnipackage.org/guides/best_practices/index.md) and [`omnipackage portal`](https://docs.omnipackage.org/cli/portal/index.md).
