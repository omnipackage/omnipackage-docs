...
Build packages for the distros defined in `.omnipackage/config.yml` without publishing. A successful run produces `.rpm` / `.deb` files under `--build-dir`, ready for [`publish`](https://docs.omnipackage.org/cli/publish/index.md).
