...
1. [OmniPackage repositories](https://repositories.omnipackage.org/omnipackage-rs/stable/install.html) — recommended
1. [AUR](https://aur.archlinux.org/packages/omnipackage) — Arch alternative, e.g. `yay -S omnipackage`
1. [Source](https://github.com/omnipackage/omnipackage-rs/) — requires Rust 1.85+ (2024 edition)
