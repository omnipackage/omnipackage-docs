...
| ---------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `distro`               | yes      | Distro ID — see [Supported distros](https://docs.omnipackage.org/distros/index.md). Unknown IDs are silently skipped at build time                                                                                |
...
| *(custom fields)*      | no       | Arbitrary scalar values (string, bool, int, float — not arrays or objects) passed straight into the template context. See [Templates](https://docs.omnipackage.org/guides/templates/#custom-per-distro-variables) |
